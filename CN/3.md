...
![Suspension_Policy(B)](./images/Suspension_Policy(B).png)
...
![table_3-9_error_codes_2](./images/table_3-9_error_codes_2.png)
...
![table_3-10_vaild_component_calls](./images/table_3-10_vaild_component_calls.png)
...
![figure_3-5_component_initialization](./images/figure_3-5_component_initialization.png)
图 3-5 Component Initialization
...
![figure_3-6_Data_tunneling](./images/figure_3-6_Data_tunneling.png)
图 3-6 Example of Data Tunneling Among OpenMAC IL Components
...
##### 隧道设置流程（图 3-7）
![figure_3-7_Tunnel_setup](./images/figure_3-7_Tunnel_setup.png)
图 3-7 Tunnel Setup
...
##### 缓冲区提供者覆盖流程（图 3-8）
![figure_3-8_buffer_supplier_override](./images/figure_3-8_buffer_supplier_override.png)
图 3-8 IL client Buffer Supplier Override
...
![figure_3-9_Tunneling_Example](./images/figure_3-9_Tunneling_Example.png)
图 3-9 Tunneling Example

![figure_3-10_station_transtion_to_idle](./images/figure_3-10_station_transtion_to_idle.png)
图 3-10 State Transtion to idle in the Case of Tunneled Components
...
![figure_3-11_data_flow_2_non-tunneled_componnents](./images/figure_3-11_data_flow_2_non-tunneled_componnents.png)
图 3-11 Data Flow Bettween Non-tunneled Components
...
![figure_3-12_data_flow_bettwen_tunneled_components](./images/figure_3-12_data_flow_bettwen_tunneled_components.png)
图 3-12
...
2. **数据流示例（图 3-13）**：
![figure_3-13_data_flow_with_proprietary](./images/figure_3-13_data_flow_with_proprietary.png)
图 3-13
...
![figure_3-14_de-initialization_of_non-tunneled](./images/figure_3-14_de-initialization_of_non-tunneled.png)
图 3-14

#### 3.4.3.2 隧道模式反初始化（Tunneled De-initialization）
隧道端口所属组件的反初始化流程与非隧道模式类似，但需额外处理隧道间的缓冲区归还逻辑，具体流程详见图 3-15（隧道组件的反初始化）。
![figure_3-15_De-initialization_Tunneled_components](./images/figure_3-15_De-initialization_Tunneled_components.png)
图 3-15
...
![figure_3-16_Distablement_and_Enablement_of_tunneled_ports](./images/figure_3-16_Distablement_and_Enablement_of_tunneled_ports.png)
图 3-16
...
![figure_3-17_Disablement_and_enablement_of_Non-tunneled_ports](./images/figure_3-17_Disablement_and_enablement_of_Non-tunneled_ports.png)
图 3-17
...
![figure_3-18_Dynamic_port_reconfiguration](./images/figure_3-18_Dynamic_port_reconfiguration.png)
图 3-18
...
![figure_3-19_Autodetect_port_reconfiguration](./images/figure_3-19_Autodetect_port_reconfiguration.png)
图 3-19
...
![figure_3-20_Transtion_from_loaded_to_idle](./images/figure_3-20_Transtion_from_loaded_to_idle.png)
图 3-20
...
![figure_3-21_Busy_resource_Management](./images/figure_3-21_Busy_resource_Management.png)
图 3-21 
...
![figure_3-22_state_change_from_loaded_to_waitforResources](./images/figure_3-22_state_change_from_loaded_to_waitforResources.png)
图 3-22

![figure_3-23_Remove_component_from_waiting_status](./images/figure_3-23_Remove_component_from_waiting_status.png)
图 3-23
1. **进入等待状态（图 3-22）**：
